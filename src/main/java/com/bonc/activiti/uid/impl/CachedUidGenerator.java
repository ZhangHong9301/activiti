 ...
 */
package com.bonc.activiti.uid.impl;

import com.bonc.activiti.uid.buffer.BufferPaddingExecutor;
import com.bonc.activiti.uid.buffer.RejectedPutBufferHandler;
import com.bonc.activiti.uid.buffer.RejectedTakeBufferHandler;
import com.bonc.activiti.uid.buffer.RingBuffer;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public long getUID() {
        try {
            long take = ringBuffer.take();
            LOGGER.info("CachedUidGenerator UID : {}", take);
            return take;
        } catch (Exception e) {
